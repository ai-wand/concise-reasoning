...
if __name__ == "__main__":
    ...
    parser.add_argument("--penalize_long_cot", action="store_true", help="Penalizing long responses")
    parser.add_argument("--step_threshold", type=int, default=0, help="The step at which we start penalizing long COT")
    parser.add_argument("--cot_threshold_low", type=float, default=1000, help="The length at which we start penalizing")
    parser.add_argument("--cot_threshold_high", type=float, default=1400, help="The length at which penalizing is the highest")
    parser.add_argument("--reward_high", type=float, default=-1, help="Reward at the high threshold")
